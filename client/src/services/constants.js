...
export const PLANS = [
  { id:'basic',    name:'Basic Shield',    pct:2, coverageMultiplier:0.60,
    desc:'Essential protection for low-risk zones', recommended:false,
    features:['60% income replacement','Environmental triggers only','UPI payout within 24hrs'] },
  { id:'standard', name:'Standard Shield', pct:3, coverageMultiplier:0.80,
    desc:'Best value — recommended for most workers', recommended:true,
    features:['80% income replacement','All trigger types','UPI payout within 4hrs','AI fraud protection'] },
  { id:'premium',  name:'Premium Shield',  pct:5, coverageMultiplier:1.00,
    desc:'Full protection for high-risk zones', recommended:false,
...
export const DISRUPTIONS = [
  ...
  { id:'ops-platform', name:'Platform Server Outage',   type:'Operational',   icon:'📱', level:'High',     riskPoints:18, bgColor:'#EEEDFE', trigger:'Uptime < 95%',           api:'Platform API' },
...
export const CITIES = ['Chennai','Mumbai','Delhi','Bengaluru','Hyderabad','Kolkata','Pune','Ahmedabad','Surat','Jaipur'];
